...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Edit Home Slider</h5>
        <a href="{{ route('admin.home_sliders.index') }}" class="btn btn-outline-secondary btn-sm">Back to Home Sliders</a>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.home_sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Enter slider title" value="{{ old('title', $slider->title) }}">
                </div>
                @error('title')
            ...
            <div class="mb-3">
                ...
                <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Enter slider description">{{ old('description', $slider->description) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="url" id="link" name="link" class="form-control @error('link') is-invalid @enderror" placeholder="Enter link URL" value="{{ old('link', $slider->link) }}">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-switch">
                    <input
                        ...
                        name="opens_new_tab"
                        value="1"
                        {{ old('opens_new_tab', $slider->opens_new_tab) ? 'checked' : '' }}>
            ...
            <div class="mb-3">
                ...
                @if($slider->cover)
                    <div class="mt-2 align-center">
                        <img src="{{ $slider->cover }}" alt="Cover Image" class="img-fluid" style="max-width: 200px;">
                    </div>
                @endif
                @error('cover')
                    <div class="text-danger mt-1">{{ $message }}</div>
